---
title: Onderzoek Azure SQL
linktitle: Onderoek SQL
type: book
...
|----|----|----|----|
| Best toepasbaar voor | {{<figure library="true" src="sql-db.png" title="Azure SQL Database">}} | {{<figure library="true" src="sql-managed-instance.png" title="Azure SQL Managed Instance">}} | {{<figure library="true" src="sql-vm.png" title="Azure SQL VM">}} |
